...
export const routingComponents = [ CreateUserComponent, LoginComponent, DashboardComponent, ResetPasswordComponent, ForgotPasswordComponent, CreateNewPasswordComponent];
